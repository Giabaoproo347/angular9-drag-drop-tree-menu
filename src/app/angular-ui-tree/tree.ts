...
export class Tree {
  private _children: Tree[] | any;
  private _loadChildren: ChildrenLoadingFunction | any;
  ...
  public node: TreeModel | any;
  public parent: Tree | any;
  ...
  hasLoadedChildern(): any {
    return !isEmpty(this.children);
  }

  loadedChildrenAmount(): any {
    return size(this.children);
  }

  checkedChildrenAmount(): any {
   ...
   */
  public addSibling(sibling: Tree, position?: number): any {
